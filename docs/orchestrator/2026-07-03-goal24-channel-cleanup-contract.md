...
Decision: `source-consumed-runtime-cleanup-blocked`.
...
FlipFlop may acknowledge `sideEffectsHandled.channel=true` for centralOrderHash `04d7d08c82a07853` only after complete provider, Orders, Warehouse, channel cleanup, idempotency, and final redacted evidence sections exist for the same selected run.
