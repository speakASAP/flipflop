...
export default function UserDashboardPage() {
  ...
  const getStatusText = (status?: string) => getOrderLifecycleLabel(status, 'Stav není dostupný');

  const getCentralNotice = (order: Order) => {
    const central = order.centralOrder;
    if (!central) return 'Objednávka zatím nemá potvrzený centrální Orders stav.';
