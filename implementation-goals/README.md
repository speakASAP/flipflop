...
| `GOAL-03-catalog-stock-storefront` | active | Goal 01 and Goal 02 provider findings/bypass | Product catalog, images, categories, price display, and stock state are production-ready |
