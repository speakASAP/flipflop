...
| `GOAL-13-product-detail-bundle-discount-contract` | implemented-validated-deployed | GOAL-12 product detail upsell boundary and GOAL-13 ecosystem real bundle selling blocker | Server-side bundle discount contract applies validated product-detail set savings to order/payment totals safely |
