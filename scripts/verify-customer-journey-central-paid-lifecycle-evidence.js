...
assert(Array.isArray(runtime.remainingBlockers) && runtime.remainingBlockers.length === 0, 'central paid lifecycle evidence must have no remaining central blockers');
