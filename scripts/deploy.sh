#!/bin/bash
# flipflop-service Application Deployment Script
# Usage: ./scripts/deploy.sh
#
# This script deploys the flipflop-service application to production using the
...
echo -e "${BLUE}╔════════════════════════════════════════════════════════════╗${NC}"
echo -e "${BLUE}║     flipflop-service Application - Production Deployment   ║${NC}"
echo -e "${BLUE}╚════════════════════════════════════════════════════════════╝${NC}"
echo ""
...
if [ $DEPLOY_EXIT_CODE -eq 0 ]; then
    ...
    echo ""
    echo "The flipflop-service application has been deployed using blue/green deployment."
